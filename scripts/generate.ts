...
const systemPrompt = [
  ...
  '- Post-2016 IEC orthography. The 2016 reform cut diacritics from about 150',
  '  words to 15. ONLY these keep an accent, and only in the sense given:',
  '    bé, Déu, és, mà, més, món, pèl, què, sé, sí, sòl, són, té, ús, vós',
  '  Everything else is written without one: soc (not sóc), adeu (not adéu),',
  '  dona, net, os, sec, mora, fora, ves, venen, feu. Ordinary stress accents',
  '  are untouched by this rule: cafè, gràcies, tomàquets, matí, cèntims.',
